...
public class UserController {
    ...
    @PatchMapping("/edit-roles/{userId}")
    public ResponseEntity<String> updateUserRole(@PathVariable @NotNull @Min(1) Integer userId,
                               @Valid @RequestBody List<RoleDTO> roleDTOs) {
        userService.changeUserRoles(userId, roleDTOs);
